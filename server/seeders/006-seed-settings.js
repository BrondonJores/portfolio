...
module.exports = {
  async up(queryInterface) {
    ...
    const settings = [
      ...
      { key: 'anim_profile', value: 'balanced' },
      { key: 'anim_reduce_motion_mode', value: 'auto' },
      { key: 'anim_duration_scale', value: '1' },
      { key: 'anim_intensity', value: '1' },
      { key: 'anim_ease_preset', value: 'easeOut' },
      { key: 'anim_section_reveal_type', value: 'fade-up' },
      { key: 'anim_section_duration_ms', value: '650' },
      { key: 'anim_section_distance_px', value: '36' },
      { key: 'anim_section_once', value: 'true' },
      { key: 'anim_card_hover', value: 'true' },
      { key: 'anim_card_lift_px', value: '8' },
      { key: 'anim_card_scale', value: '1.02' },
      { key: 'anim_card_tilt_deg', value: '1.5' },
      { key: 'anim_cta_pulse', value: 'true' },
      { key: 'anim_cta_pulse_interval_ms', value: '1800' },
      { key: 'anim_mascots_enabled', value: 'true' },
      { key: 'anim_mascot_count', value: '4' },
      { key: 'anim_mascot_size', value: '96' },
      { key: 'anim_mascot_speed', value: '1' },
      { key: 'anim_mascot_opacity', value: '0.85' },
      { key: 'anim_mascot_style', value: 'mixed' },
      { key: 'anim_scroll_progress_enabled', value: 'true' },
      { key: 'anim_scroll_progress_thickness', value: '4' },
