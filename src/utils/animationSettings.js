...
export function getAnimationConfig(settings = {}, prefersReducedMotion = false) {
  ...
  return {
    ...
    mascotSizePx: clampNumber(settings.anim_mascot_size, 72, 220, 112) * Math.max(0.75, intensity),
    ...
    mascotStyle: settings.anim_mascot_style || 'section',
