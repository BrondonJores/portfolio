...
/**
 * Construit la trajectoire du sprite principal.
 ...
 */
function buildWanderTrack(viewport, spriteSize) {
  const minX = 40
  const minY = 40
 ...
 */
function buildSideAnimation(edge, sideSize, baseOpacity, bouncePx, rotationDeg) {
...
export default function AnimatedSpriteSystem() {
  ...
  const wanderTrack = buildWanderTrack(viewport, wanderSize)
